...
const media = {
  heroVehicle: '/images/reco/RECO_Hero_01_Exhaust_Vehicle.webp',
  heroProduct: '/images/reco/RECO_Hero_02_Product_Studio.webp',
  heroCommercial: '/images/reco/RECO_Hero_03_Commercial_Vehicles.webp',
  welding: '/images/reco/RECO_Detail_01_Welding.webp',
  muffler: '/images/reco/RECO_Detail_02_Muffler_Closeup.webp',
  manufacturing: '/images/reco/RECO_Detail_03_Pipe_Manufacturing.webp',
  factory: '/images/reco/RECO_Factory_Exterior.webp',
  productRange: '/images/reco/RECO_Product_Range.webp'
};
...
const imageCards = [
  [media.heroProduct, 'RECO silencer and exhaust product display'],
  [media.manufacturing, 'RECO exhaust pipe manufacturing detail'],
  [media.factory, 'RECO manufacturing facility'],
];

export default function Home() { return <>
  <section className="hero hero-media-led">
    <div className="hero-media-bg" style={{backgroundImage:`linear-gradient(90deg,rgba(7,25,36,.98) 0%,rgba(7,25,36,.90) 38%,rgba(7,25,36,.25) 70%,rgba(7,25,36,.12) 100%),url(${media.heroVehicle})`}}/>
  ...
  <section className="media-story-band">
    <div className="container media-story-grid">
      ...
      <Reveal className="media-story-image media-story-image-main" direction="left"><img src={media.welding} alt="RECO exhaust fabrication and welding" loading="lazy"/></Reveal>
      <Reveal className="media-story-image media-story-image-small" delay={.1}><img src={media.muffler} alt="RECO muffler internal detail" loading="lazy"/></Reveal>
    </div>
  </section>
  ...
  <section className="vehicle-band"><div className="vehicle-band-bg" style={{backgroundImage:`linear-gradient(90deg,rgba(8,34,48,.98),rgba(8,34,48,.76),rgba(8,34,48,.25)),url(${media.heroCommercial})`}}/><div className="container vehicle-band-content"><Reveal><Eyebrow light>FIND THE RIGHT FIT</Eyebrow><h2>Tell us what car you drive.</h2><p>Share the manufacturer, model, year and fuel type. Our team will help identify the suitable silencer or exhaust component.</p><Button to="/car-models" variant="teal">Find My Car<FiArrowRight/></Button></Reveal><div className="vehicle-band-stat"><strong>1988</strong><span>ESTABLISHED<br/>IN CALICUT</span></div></div></section>
