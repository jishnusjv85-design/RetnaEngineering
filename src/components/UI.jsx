...
export function BookingCTA() { return <section className="container"><Reveal className="booking-cta"><div><Eyebrow light>NEED HELP FINDING THE RIGHT PART?</Eyebrow><h2>Tell us about your car.</h2><p>Share your car model and requirement. Our team will help you check the suitable silencer or exhaust component.</p></div><div className="cta-actions"><Button to="/book-a-slot" variant="light">Book a Slot<FiArrowUpRight/></Button><a href="tel:+914952303961"><FiPhone/>0495 2303961</a></div></Reveal></section>; }
...
export function EmptyCatalogue({ model = false }) { return <div className="empty-catalogue"><span className="empty-index">RECO / YOUR CAR</span><h3>{model ? 'Cannot find your car model?' : 'Need help finding the right part?'}</h3><p>{model ? 'Contact RECO with your car details. We will check whether a suitable model-specific silencer is available.' : 'Share your manufacturer, model and fuel type. Our team will check the suitable product, availability and price.'}</p><div className="button-row"><WhatsApp text="Hello RECO, please help me find a silencer for my car."/><Button to="/book-a-slot" variant="subtle">Book an Inspection<FiArrowRight/></Button></div></div>; }
